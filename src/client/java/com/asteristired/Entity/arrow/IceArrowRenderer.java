...
public class IceArrowRenderer extends ProjectileEntityRenderer<IceArrowEntity> {
    private static final Identifier TEXTURE = new Identifier(MOD_ID, "textures/entity/projectile/ice_arrow.png");
    ...
    @Override
    public void render(IceArrowEntity entity, float yaw, float tickDelta, MatrixStack matrices,
